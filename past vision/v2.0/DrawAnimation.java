	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() != pause && e.getSource() != resume && e.getSource() != stop) {
			...
			if(loadText){
				...
				//red
				m.redposition = new double[] {Double.valueOf(redpx.getText()).doubleValue(),Double.valueOf(redpy.getText()).doubleValue(),Double.valueOf(redpz.getText()).doubleValue()};	
				m.redvelocity = new double[] {Double.valueOf(redvx.getText()).doubleValue(),Double.valueOf(redvy.getText()).doubleValue(),Double.valueOf(redvz.getText()).doubleValue()};	
				m.redmass = Double.valueOf(redm.getText()).doubleValue();
				//green
				m.greenposition = new double[] {Double.valueOf(greenpx.getText()).doubleValue(),Double.valueOf(greenpy.getText()).doubleValue(),Double.valueOf(greenpz.getText()).doubleValue()};	
				m.greenvelocity = new double[] {Double.valueOf(greenvx.getText()).doubleValue(),Double.valueOf(greenvy.getText()).doubleValue(),Double.valueOf(greenvz.getText()).doubleValue()};	
				m.greenmass = Integer.valueOf(greenm.getText()).doubleValue();
				//blue
				m.blueposition = new double[] {Double.valueOf(bluepx.getText()).doubleValue(),Double.valueOf(bluepy.getText()).doubleValue(),Double.valueOf(bluepz.getText()).doubleValue()};	
				m.bluevelocity = new double[] {Double.valueOf(bluevx.getText()).doubleValue(),Double.valueOf(bluevy.getText()).doubleValue(),Double.valueOf(bluevz.getText()).doubleValue()};	
				m.bluemass = Double.valueOf(bluem.getText()).doubleValue();
				m.init();
				loadText = false;
