	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() != pause && e.getSource() != resume && e.getSource() != stop) {
			if (!timer.isRunning()) {
				...
				Motion.tempred = Motion.red;
				Motion.tempgreen = Motion.green;
				Motion.tempblue = Motion.blue;
				...
				//update velocity
				Motion.red.setVelocity(Motion.getVelocity(Motion.tempred,Motion.red));
				Motion.green.setVelocity(Motion.getVelocity(Motion.tempgreen,Motion.green));
				Motion.blue.setVelocity(Motion.getVelocity(Motion.tempblue,Motion.blue));	
			}
		}
	}
